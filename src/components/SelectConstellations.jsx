...
export function SelectConstellations() {
  return (
    <div className="lg:w-64">
      ...
      >
        ...
        <option value="2">Objetos Messier</option>
        <option value="3">Número de Estrellas</option>
        <option value="4">Objetos NGC</option>
        <option value="5">Objetos Caldwell</option>
      </select>
    </div>
  )
}
