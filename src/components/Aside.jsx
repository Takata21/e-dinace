...
export function Aside({ isVisible, setVisible }) {
  ...
  return (
    <div className="flex items-center justify-center 1xl:flex-1">
      {/* className={clsx(
      ...
      <aside
        className={clsx(
          {
            'invisible hidden top-[9999px] h-0 1xl:visible 1xl:block 1xl:top-0': isVisible !== true,
          },
          'bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-hidden position absolute top-0  bottom-0 left-0 right-0 z-50 h-full 1xl:relative '
        )}
      >
